...
const CT_LANG = {
  ...
  id: {
    ...
    profile_change_pw: "🔑 Ubah Password",
    profile_current_pw: "Password Saat Ini",
    profile_new_pw: "Password Baru",
    profile_confirm_pw: "Konfirmasi Password Baru",
    profile_pw_hint: "Min. 8 karakter, huruf & angka.",
    profile_pw_btn: "🔒 Ubah Password",
    profile_privacy_title: "🔒 Privasi & Keamanan",
    profile_danger_title: "⚠️ Zona Berbahaya",
    profile_danger_desc: "Setelah Anda menghapus akun, semua data akan dihapus secara permanen. Ini tidak dapat dibatalkan.",
    profile_delete_btn: "🗑️ Hapus Akun",
    // CV
    cv_title: "CV Saya",
    cv_subtitle:
...
(function () {
  ...
  function updateToggles() {
    ...
    document.querySelectorAll(".lang-btn").forEach((btn) => {
      const flag = l === "id" ? "🇮🇩" : "🇬🇧";
      const label = l === "id" ? "ID" : "EN";
      btn.innerHTML = `${flag} <span class="lang-btn-text">${label}</span>`;
      btn.title = l === "id" ? "Switch to English" : "Ganti ke Bahasa Indonesia";
    });
  }
...
// ── PATCH: inject extra keys for contact pages ──
(function() {
  const extra = {
    en: {
      // contact-email
      ...
      delete_bug: "Delete Report",
      delete_feature: "Delete Request",
      ...
      feat_new_btn: "✨ Request Feature",
      feat_my_label: "My Requests",
      feat_all_label: "All Requests",
      no_reports: "No bug reports yet.",
      no_messages: "No messages yet.",
      no_features: "No feature requests yet.",
    },
    id: {
      // contact-email
      email_title: "Email Admin",
      email_subtitle: "Kirim pesan, pertanyaan, atau saran. Admin akan membalas langsung di sini.",
      email_new_msg: "Pesan Baru",
      email_select_msg: "Pilih pesan atau mulai pesan baru",
      email_compose_title: "Pesan Baru ke Admin",
      email_inbox: "Pesan Saya",
      email_all_inbox: "Semua Pesan Pengguna",
      admin_mode_msg: "👑 Mode Admin — melihat semua pesan pengguna dan dapat membalasnya.",
      // contact-bug
      bug_title: "Laporkan Bug",
      bug_subtitle: "Menemukan masalah? Bantu kami memperbaikinya dengan laporan yang detail.",
      bug_guide_title: "Cara membuat laporan bug yang baik",
      bug_guide_1: "Jelaskan apa yang seharusnya terjadi",
      bug_guide_2: "Jelaskan apa yang sebenarnya terjadi",
      bug_guide_3: "Tulis langkah-langkah untuk mereproduksinya",
      bug_guide_4: "Catat halaman/fitur yang terpengaruh",
      bug_form_title: "Kirim Laporan Bug",
      bug_form_note: "Username Anda akan dilampirkan untuk tindak lanjut.",
      bug_submit_btn: "🐛 Kirim Laporan",
      filter_all: "Semua",
      filter_open: "Terbuka",
      filter_progress: "Diproses",
      ...
      contact_subtitle: "Pertanyaan, laporan bug, atau ide fitur? Pilih saluran atau kirim pesan cepat di bawah.",
      contact_channels: "Saluran Kontak",
      contact_quick: "Pesan Cepat",
      contact_faq: "FAQ",
      contact_send: "Kirim Pesan →",
      contact_success: "✅ Pesan terkirim! Kami akan segera membalas.",
      // Delete actions
      delete_message: "Hapus Pesan",
      delete_bug: "Hapus Laporan",
      delete_feature: "Hapus Permintaan",
      confirm_delete: "Yakin ingin menghapus ini? Tindakan ini tidak bisa dibatalkan.",
      deleted_ok: "Berhasil dihapus.",
      // Contact misc
      bug_reports_title: "Laporan Bug",
      feat_new_btn: "✨ Ajukan Fitur",
      feat_my_label: "Permintaan Saya",
      feat_all_label: "Semua Permintaan",
      no_reports: "Belum ada laporan bug.",
      no_messages: "Belum ada pesan.",
      no_features: "Belum ada permintaan fitur.",
    }
  };
  Object.keys(extra).forEach(lang => {
    if (CT_LANG[lang]) Object.assign(CT_LANG[lang], extra[lang]);
  });
})();
